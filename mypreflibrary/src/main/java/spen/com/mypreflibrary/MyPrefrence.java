package spen.com.mypreflibrary;
...
public class MyPrefrence {
    ...
    private static MyPrefrence sharedPreferenceUtils;
    private SharedPreferences sharedPreferences;

    private MyPrefrence(Context context) {
        this.sharedPreferences = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
    }

    public static MyPrefrence getInstance(Context context) {
        if (sharedPreferenceUtils == null) {
            sharedPreferenceUtils = new MyPrefrence(context);
        }
        return sharedPreferenceUtils;
    }

    /**
     * Reset the singleton instance of {@link MyPrefrence}
     */
